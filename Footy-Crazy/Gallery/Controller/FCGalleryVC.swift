...
extension FCGalleryVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: FCConstants.CELL_IDENTIFIERS.gallery, for: indexPath) as? FCGalleryCell else{
            return collectionView.dequeueReusableCell(withReuseIdentifier: FCConstants.CELL_IDENTIFIERS.defaultGalleryCell, for: indexPath)
        }        
...
extension FCGalleryVC: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        performSegue(withIdentifier: FCConstants.SEGUES.galleryImageDetailVC, sender: indexPath.row)
    }
